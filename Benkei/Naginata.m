...
- (instancetype)init
{
    ...
    if (self) {
        ...
        // 編集モード1
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Command], [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_E], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Q], [NSNumber numberWithInt:kVK_ANSI_J], [NSNumber numberWithInt:kVK_ANSI_K], nil], // ^{End}
        ...
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_ANSI_Slash], [NSNumber numberWithInt:kVK_Return], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_D], [NSNumber numberWithInt:kVK_ANSI_J], [NSNumber numberWithInt:kVK_ANSI_K], nil], // ？{改行}
        ...
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_ANSI_1], [NSNumber numberWithInt:kVK_Return], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_C], [NSNumber numberWithInt:kVK_ANSI_J], [NSNumber numberWithInt:kVK_ANSI_K], nil], // ！{改行}
        ...
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_UpArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_J], [NSNumber numberWithInt:kVK_ANSI_D], [NSNumber numberWithInt:kVK_ANSI_F], nil], // {↑}
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_UpArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_K], [NSNumber numberWithInt:kVK_ANSI_D], [NSNumber numberWithInt:kVK_ANSI_F], nil], // +{↑}
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_UpArrow], [NSNumber numberWithInt:kVK_UpArrow], [NSNumber numberWithInt:kVK_UpArrow], [NSNumber numberWithInt:kVK_UpArrow], [NSNumber numberWithInt:kVK_UpArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_L], [NSNumber numberWithInt:kVK_ANSI_D], [NSNumber numberWithInt:kVK_ANSI_F], nil], // {↑ 5}
        ...
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_DownArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_D], [NSNumber numberWithInt:kVK_ANSI_F], nil], // {↓}
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_DownArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Comma], [NSNumber numberWithInt:kVK_ANSI_D], [NSNumber numberWithInt:kVK_ANSI_F], nil], // +{↓}
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_DownArrow], [NSNumber numberWithInt:kVK_DownArrow], [NSNumber numberWithInt:kVK_DownArrow], [NSNumber numberWithInt:kVK_DownArrow], [NSNumber numberWithInt:kVK_DownArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Period], [NSNumber numberWithInt:kVK_ANSI_D], [NSNumber numberWithInt:kVK_ANSI_F], nil], // {↓ 5}
        ...
        [NSArray arrayWithObjects: @"｜", [NSNumber numberWithInt:kVK_Return], [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_E], @"《》", [NSNumber numberWithInt:kVK_Return], [NSNumber numberWithInt:kVK_UpArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_W], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_Comma], nil], // ｜{改行}{End}《》{改行}{↑}
        ...
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_UpArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Y], [NSNumber numberWithInt:kVK_ANSI_C], [NSNumber numberWithInt:kVK_ANSI_V], nil], // +{Home}
        ...
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_RightArrow], [NSNumber numberWithInt:kVK_RightArrow], [NSNumber numberWithInt:kVK_RightArrow], [NSNumber numberWithInt:kVK_RightArrow], [NSNumber numberWithInt:kVK_RightArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_J], [NSNumber numberWithInt:kVK_ANSI_C], [NSNumber numberWithInt:kVK_ANSI_V], nil], // {→ 5}
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_RightArrow], [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_RightArrow], [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_RightArrow], [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_RightArrow], [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_RightArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_K], [NSNumber numberWithInt:kVK_ANSI_C], [NSNumber numberWithInt:kVK_ANSI_V], nil], // +{→ 5}
        ...
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_LeftArrow], [NSNumber numberWithInt:kVK_LeftArrow], [NSNumber numberWithInt:kVK_LeftArrow], [NSNumber numberWithInt:kVK_LeftArrow], [NSNumber numberWithInt:kVK_LeftArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_C], [NSNumber numberWithInt:kVK_ANSI_V], nil], // {← 5}
        [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_LeftArrow], [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_LeftArrow], [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_LeftArrow], [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_LeftArrow], [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_LeftArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Comma], [NSNumber numberWithInt:kVK_ANSI_C], [NSNumber numberWithInt:kVK_ANSI_V], nil], // +{← 5}
