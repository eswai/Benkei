...
- (instancetype)init
{
    ...
    if (self) {
        ...
        ng_keymap = [NSDictionary dictionaryWithObjectsAndKeys:
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_N], [NSNumber numberWithInt:kVK_ANSI_U], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_Space], [NSNumber numberWithInt:kVK_ANSI_W], nil], // ぬ
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_N], [NSNumber numberWithInt:kVK_ANSI_U], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_Return], [NSNumber numberWithInt:kVK_ANSI_W], nil], // ぬ
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_N], [NSNumber numberWithInt:kVK_ANSI_E], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_Space], [NSNumber numberWithInt:kVK_ANSI_R], nil], // ね
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_N], [NSNumber numberWithInt:kVK_ANSI_E], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_Return], [NSNumber numberWithInt:kVK_ANSI_R], nil], // ね
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_V], [NSNumber numberWithInt:kVK_ANSI_U], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Q], nil], // ゔ
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_V], [NSNumber numberWithInt:kVK_ANSI_A], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Q], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_J], nil], // ゔぁ
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_V], [NSNumber numberWithInt:kVK_ANSI_I], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Q], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_K], nil], // ゔぃ
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_V], [NSNumber numberWithInt:kVK_ANSI_E], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Q], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_O], nil], // ゔぇ
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_V], [NSNumber numberWithInt:kVK_ANSI_O], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Q], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_N], nil], // ゔぉ
            ...
            // 編集モード2
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_A], [NSNumber numberWithInt:kVK_ForwardDelete], [NSNumber numberWithInt:kVK_ForwardDelete], [NSNumber numberWithInt:kVK_ForwardDelete], [NSNumber numberWithInt:kVK_Delete], [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_N], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Q], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_Comma], nil], // {Home}{Del 3}{BS}{←}
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Command], [NSNumber numberWithInt:kVK_ANSI_X], @"｜", [NSNumber numberWithInt:kVK_Command], [NSNumber numberWithInt:kVK_ANSI_V], @"《》", [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_B], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_W], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_Comma], nil], // ^x｜{改行}^v《》{改行}{↑}
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_A], [NSNumber numberWithInt:kVK_Return], [NSNumber numberWithInt:kVK_Space], [NSNumber numberWithInt:kVK_Space], [NSNumber numberWithInt:kVK_Space], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_E], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_Comma], nil], // {Home}{改行}{Space 3}{←}
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_A], [NSNumber numberWithInt:kVK_ForwardDelete], [NSNumber numberWithInt:kVK_Delete], [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_N], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_A], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_Comma], nil], // {Home}{Del 1}{BS}{←}
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_A], [NSNumber numberWithInt:kVK_Return], [NSNumber numberWithInt:kVK_Space], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_D], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_Comma], nil], // {Home}{改行}{Space 1}{←}
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Command], [NSNumber numberWithInt:kVK_ANSI_X], @"『", [NSNumber numberWithInt:kVK_Command], [NSNumber numberWithInt:kVK_ANSI_V], @"』", [NSNumber numberWithInt:kVK_Space], [NSNumber numberWithInt:kVK_Shift], [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_B], [NSNumber numberWithInt:kVK_Command], [NSNumber numberWithInt:kVK_ANSI_X], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_G], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_Comma], nil], // ^x『^v』{改行}{Space}+{↑}^x
            [NSArray arrayWithObjects: @"　　　×　　　×　　　×", [NSNumber numberWithInt:kVK_Return], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Z], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_Comma], nil], // 　　　×　　　×　　　×{改行 2}
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Return], [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_E], [NSNumber numberWithInt:kVK_Return], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_C], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_Comma], nil], // {改行}{End}{改行}}
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_E], [NSNumber numberWithInt:kVK_Return], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_B], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_Comma], nil], // {End}{改行}
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Command], [NSNumber numberWithInt:kVK_ANSI_Z], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_I], [NSNumber numberWithInt:kVK_ANSI_C], [NSNumber numberWithInt:kVK_ANSI_V], nil], // ^z
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_Command], [NSNumber numberWithInt:kVK_ANSI_V], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_P], [NSNumber numberWithInt:kVK_ANSI_C], [NSNumber numberWithInt:kVK_ANSI_V], nil], // ^v
