...
//            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_X], [NSNumber numberWithInt:kVK_ANSI_W], [NSNumber numberWithInt:kVK_ANSI_A], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Q], [NSNumber numberWithInt:kVK_ANSI_L], nil], // ゎ
            ...
            [NSArray arrayWithObjects: @"｜", [NSNumber numberWithInt:kVK_Control], [NSNumber numberWithInt:kVK_ANSI_E], @"《》", [NSNumber numberWithInt:kVK_UpArrow], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_W], [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_Comma], nil], // ｜{改行}{End}《》{改行}{↑}
