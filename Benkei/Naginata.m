...
- (instancetype)init
{
    ...
    if (self) {
        ...
        ng_keymap = [NSDictionary dictionaryWithObjectsAndKeys:
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_E], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_Space], [NSNumber numberWithInt:kVK_ANSI_B], nil], // め
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_M], [NSNumber numberWithInt:kVK_ANSI_E], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_Return], [NSNumber numberWithInt:kVK_ANSI_B], nil], // め
