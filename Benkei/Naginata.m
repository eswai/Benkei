...
- (instancetype)init
{
    ...
    if (self) {
        ...
        ng_keymap = [NSDictionary dictionaryWithObjectsAndKeys:
            ...
            [NSArray arrayWithObjects: [NSNumber numberWithInt:kVK_ANSI_V], [NSNumber numberWithInt:kVK_ANSI_U], nil], [NSSet setWithObjects: [NSNumber numberWithInt:kVK_ANSI_Q], [NSNumber numberWithInt:kVK_Space], nil], // ゔ
